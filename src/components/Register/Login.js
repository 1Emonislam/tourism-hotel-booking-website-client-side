            ...
            <>
                <div className="container">
                    <div className="box-google">
                        <h5 className="title pb-4 text-center">Login With</h5>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-success px-4"> {users?.email && 'already logined'} {users?.email && <Link to="/home"> Back to Home</Link>}</p>
                        </div>
                        <p className="px-4 text-center text-muted">don't have an account? <Link to="/register"> Create an Account</Link></p>
                    </div>
                </div>
            </>
        </>
